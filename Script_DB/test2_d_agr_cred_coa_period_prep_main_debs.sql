drop FUNCTION IF EXISTS s_grnplm_as_t_didsd_nnn_db_tmd.sp_dm_ent_ld_d_agr_cred_coa_period_prep_main_debts(BIGINT);
CREATE OR REPLACE FUNCTION s_grnplm_as_t_didsd_nnn_db_tmd.sp_dm_ent_ld_d_agr_cred_coa_period_prep_main_debts(IN in_workflow_run_id BIGINT, out return_int_return_code int4)
RETURNS int4
language plpgsql
as
--do
					...
					select t.* 
					 ...
					 from 
						...
						from (
                            	...
                            	from s_grnplm_as_t_didsd_nnn_db_tmd.d_agr_cred_coa_period_prep_bal_'||in_workflow_run_id::text||' t
                            	left
...
sql_query := 'analyze s_grnplm_as_t_didsd_nnn_db_tmd.d_agr_cred_coa_period_prep_main_debts_'||in_workflow_run_id::text||';';
    EXECUTE sql_query;
