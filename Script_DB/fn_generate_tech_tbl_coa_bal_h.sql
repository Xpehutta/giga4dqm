...
create table s_grnplm_as_t_didsd_nnn_db_tmd.d_tech_tbl_coa_bal_h_'||in_workflow_run_id::text||' (like s_grnplm_as_t_didsd_nnn_db_tmd.d_tech_tbl_coa_bal_h) distributed by(agr_id);';
execute v_query;
