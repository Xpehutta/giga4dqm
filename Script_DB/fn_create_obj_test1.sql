...
BEGIN
-- s_grnplm_as_t_didsd_nnn_db_tmd.t_coa definition
...
DISTRIBUTED BY (coa_id)
PARTITION BY LIST(info_system_inst_cd)
(
PARTITION p_000004 VALUES('000004') WITH (appendonly='true', compresstype=zstd, compresslevel='3'),
PARTITION p_000005 VALUES('000005') WITH (appendonly='true', compresstype=zstd, compresslevel='3'),
PARTITION p_000021 VALUES('000021') WITH (appendonly='true', compresstype=zstd, compresslevel='3'),
PARTITION p_000027 VALUES('000027') WITH (appendonly='true', compresstype=zstd, compresslevel='3')
);
...
DISTRIBUTED BY (je_header_id)
PARTITION BY LIST(info_system_inst_cd)
SUBPARTITION BY RANGE(je_header_val_dt)
(
PARTITION p_000004 VALUES('000004') WITH (appendonly='true', compresstype=zstd, compresslevel='3')
(
START ('1900-01-01'::date) END ('2023-01-01'::date) WITH (appendonly='true', compresstype=zstd, compresslevel='3'),
START ('2023-01-01'::date) END ('2030-01-01'::date) EVERY ('1 mon'::interval) WITH (appendonly='true', compresstype=zstd, compresslevel='3'),
START ('2030-01-01'::date) END ('9999-12-31'::date) INCLUSIVE WITH (appendonly='true', compresstype=zstd, compresslevel='3')
),
PARTITION p_000027 VALUES('000027') WITH (appendonly='true', compresstype=zstd, compresslevel='3')
(
START ('1900-01-01'::date) END ('2023-01-01'::date) WITH (appendonly='true', compresstype=zstd, compresslevel='3'),
...
PARTITION BY LIST (info_system_inst_cd)
(
PARTITION p_000004 VALUES('000004') WITH (appendonly='true', compresstype=zstd, compresslevel=1),
PARTITION p_000027 VALUES('000027') WITH (appendonly='true', compresstype=zstd, compresslevel=1)
);
...
DISTRIBUTED BY (src_system_type_id)
PARTITION BY LIST(info_system_inst_cd)
(
PARTITION p_000004 VALUES('000004') WITH (appendonly='true', compresstype=zstd, compresslevel='3'),
PARTITION p_000005 VALUES('000005') WITH (appendonly='true', compresstype=zstd, compresslevel='3'),
...
DISTRIBUTED BY (workflow_run_id);
