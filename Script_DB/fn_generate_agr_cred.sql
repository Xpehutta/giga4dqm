...
create table s_grnplm_as_t_didsd_nnn_db_tmd.d_agr_cred_'||in_workflow_run_id::text||' (like s_grnplm_as_t_didsd_nnn_db_tmd.d_agr_cred) distributed by(agr_cred_id);';
execute v_query;
