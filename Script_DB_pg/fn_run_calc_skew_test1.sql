drop FUNCTION if exists s_grnplm_as_t_didsd_nnn_db_tmd.fn_run_calc_skew_test1();
CREATE OR REPLACE FUNCTION s_grnplm_as_t_didsd_nnn_db_tmd.fn_run_calc_skew_test1(out return_int_return_code int4)
 RETURNS int4
LANGUAGE plpgsql
AS $$
DECLARE
   ...
   v_proc text :='fn_run_calc_skew_test1_'||v_workflow_run_id::text;
   v_data_wf bigint;
   v_error_msg text;
   v_sql text;
