drop FUNCTION if exists s_grnplm_as_t_didsd_nnn_db_tmd.fn_gen_data_test3(bigint,bigint,bigint);
CREATE OR REPLACE FUNCTION s_grnplm_as_t_didsd_nnn_db_tmd.fn_gen_data_test3(in_num_records bigint,in_max_agr_per_coa bigint, in_batch_size bigint, out return_int_return_code int4)
 RETURNS int4
LANGUAGE plpgsql
AS $$
DECLARE
...
delete from s_grnplm_as_t_didsd_nnn_db_tmd.t_str_pilot_tune where test_num='test3';
...
insert into s_grnplm_as_t_didsd_nnn_db_tmd.t_str_pilot_tune(test_num,data_workflow_run_id,sp_workflow_run_id) values('test3',v_workflow_run_id,0); 
